...
void MOSInstrInfo::expandLDSTstk(MachineIRBuilder &Builder) const {
  ...
  if (MOS::ZP_PTRRegClass.contains(Base) && Offset >= 256) {
    ...
    if (TRI.isSubRegisterEq(Loc, Tmp)) {
      Tmp = Tmp == MOS::ZP_PTR_0 ? MOS::ZP_PTR_1 : MOS::ZP_PTR_0;
    }
...
void MOSInstrInfo::expandIncSP(MachineIRBuilder &Builder) const {
  ...
  if (LoBytes) {
    ...
    Builder.buildInstr(MOS::ADCzpr)
        ...
        .addUse(MOS::SPlo)
        .addUse(MOS::C);
    Builder.buildInstr(MOS::STzpr).addDef(MOS::SPlo).addUse(MOS::A);
  }
  ...
  Builder.buildInstr(MOS::ADCzpr)
      ...
      .addUse(MOS::SPhi)
      .addUse(MOS::C);
  Builder.buildInstr(MOS::STzpr).addDef(MOS::SPhi).addUse(MOS::A);
}
...
void MOSInstrInfo::preserveAroundPseudoExpansion(
  ...
  if (Save.test(MOS::ZP_0)) {
    assert(!Save.test(MOS::ZP_2));
    Builder.buildInstr(MOS::PHP);
    Builder.buildInstr(MOS::PHA);
    Builder.buildInstr(MOS::LDzpr).addDef(MOS::A).addUse(MOS::ZP_0);
    Builder.buildInstr(MOS::STabs)
        .addUse(MOS::A)
  ...
  if (Save.test(MOS::ZP_1)) {
    assert(!Save.test(MOS::ZP_3));
    Builder.buildInstr(MOS::PHP);
    Builder.buildInstr(MOS::PHA);
    Builder.buildInstr(MOS::LDzpr).addDef(MOS::A).addUse(MOS::ZP_1);
    Builder.buildInstr(MOS::STabs)
        .addUse(MOS::A)
  ...
  if (Save.test(MOS::ZP_2)) {
    assert(!Save.test(MOS::ZP_0));
    Builder.buildInstr(MOS::PHP);
    Builder.buildInstr(MOS::PHA);
    Builder.buildInstr(MOS::LDzpr).addDef(MOS::A).addUse(MOS::ZP_2);
    Builder.buildInstr(MOS::STabs)
        .addUse(MOS::A)
        .addExternalSymbol("_SaveZPlo");
    Builder.buildInstr(MOS::PLA);
  ...
  if (Save.test(MOS::ZP_3)) {
    assert(!Save.test(MOS::ZP_1));
    Builder.buildInstr(MOS::PHP);
    Builder.buildInstr(MOS::PHA);
    Builder.buildInstr(MOS::LDzpr).addDef(MOS::A).addUse(MOS::ZP_3);
    Builder.buildInstr(MOS::STabs)
        .addUse(MOS::A)
        .addExternalSymbol("_SaveZPhi");
    Builder.buildInstr(MOS::PLA);
  ...
  if (Save.test(MOS::ZP_0)) {
    ...
    Builder.buildInstr(MOS::LDabs)
        .addDef(MOS::A)
        .addExternalSymbol("_SaveZPlo");
    Builder.buildInstr(MOS::STzpr).addDef(MOS::ZP_0).addUse(MOS::A);
    Builder.buildInstr(MOS::PLA);
    Builder.buildInstr(MOS::PLP);
  }
  if (Save.test(MOS::ZP_1)) {
    ...
    Builder.buildInstr(MOS::LDabs)
        .addDef(MOS::A)
        .addExternalSymbol("_SaveZPhi");
    Builder.buildInstr(MOS::STzpr).addDef(MOS::ZP_1).addUse(MOS::A);
    Builder.buildInstr(MOS::PLA);
    Builder.buildInstr(MOS::PLP);
  }
  if (Save.test(MOS::ZP_2)) {
    ...
    Builder.buildInstr(MOS::LDabs)
        .addDef(MOS::A)
        .addExternalSymbol("_SaveZPlo");
    Builder.buildInstr(MOS::STzpr).addDef(MOS::ZP_2).addUse(MOS::A);
    Builder.buildInstr(MOS::PLA);
    Builder.buildInstr(MOS::PLP);
  }
  if (Save.test(MOS::ZP_3)) {
    ...
    Builder.buildInstr(MOS::LDabs)
        .addDef(MOS::A)
        .addExternalSymbol("_SaveZPhi");
    Builder.buildInstr(MOS::STzpr).addDef(MOS::ZP_3).addUse(MOS::A);
    Builder.buildInstr(MOS::PLA);
    Builder.buildInstr(MOS::PLP);
  }
