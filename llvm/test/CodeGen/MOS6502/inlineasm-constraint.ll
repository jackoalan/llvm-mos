...
; CHECK-LABEL: test__inline__constraint__a:
define void @test_inline_constraint_a() {
...
; CHECK-LABEL: test__inline__constraint__x:
define void @test_inline_constraint_x() {
...
; CHECK-LABEL: test__inline__constraint__y:
